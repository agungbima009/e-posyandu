<div style="width: 600px;">
    ...
    <div class="form-group">
        ...
        <div class="row">
            <div class="col">
                <div class="form-group">
                <label for="pos">Diberikan imunisasi:</label>
            <select class="form-control" id="pos" name="pos">
                <option value="pos0">pilih imunisasi</option>
            ...
            <div class="col">
                <div class="form-group">
                <label for="pos">Pelayanan yang diberikan</label>
            <select class="form-control" id="pos" name="pos">
                <option value="pos0">pilih Pelayanan</option>
                <option value="pos1">Posyandu 1</option>
                <option value="pos2">Posyandu 2</option>
                <option value="pos3">Posyandu 3</option>
                <option value="pos4">Posyandu 4</option>
