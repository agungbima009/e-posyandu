...
function insertibu($data)
{
  ...
  $query = "INSERT INTO `data_ibu` (`NIK`, `nama_ibu`, `suami`, `rt_rw`, `no_telp`, `kd_pos`) VALUES ('$nik', '$namaibu', '$namaayah', '$tlpn', '$rtrw', '$kdpos');";
...
//   // Buat query SQL untuk menyimpan data bidan, termasuk foto jika ada
//   $query = "UPDATE `data_bidan` SET `status_aktif` = 'offline' WHERE `data_bidan`.`NIP` = '9876541212';";
