<div class="m-3">
    ...
    <div class="row pt-3">
                    ...
                    <table class="table align-middle mb-0">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>Bidan</td>
                                <td>
                                    <button type="button" class="btn btn-outline-primary" style="border-radius: 20px; width: 70px;">
                                        Edit
                                    </button>
                                </td>
                            </tr>
        ...
        <div class="col" style=" height:200px;">
            <div class="card ms-3 border-info" style=" border-radius: 40px;">
                <div class="border-info p-5 d-flex justify-content-between">
                    <div class="col-5">
                        <canvas id="myChart" width="80" height="80"></canvas>
                    </div>
                    <div class="col-5 d-flex flex-column justify-content-center">
                        <h3>Data perkembangan<br><b>Berat Anak</b></h3>
                    </div>
                </div>
            </div>
        </div>
