    ...
    <label for="nik">NIK:</label>
        ...
        <div class="col">
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="tanggal_lahir" name="tempat_lahir">
                </div>
            </div>
            <div class="col">
                <div class="form-group">
        ...
        <div class="col">
            ...
            <input type="date" class="form-control" id="nama_ayah" name="nama_ayah">
                </div>
            </div>
            <div class="col">
                <div class="form-group">
                <label for="nama_ibu">Tanggal meninggal ibu:</label>
            <input type="date" class="form-control" id="nama_ibu" name="nama_ibu">
                </div>
            </div>
        </div>
        <div class="form-group">
