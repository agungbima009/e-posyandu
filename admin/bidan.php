...
<body>
    ...
    <div class="sidebar close">
        ...
        <ul class="nav-links">
            ...
            <li>
                <a href="#" onclick="toggleContent('chatContent')">

                    <i class='bx bx-conversation'></i>
                    <span class="link_name">chat</span>
                </a>
                <ul class="sub-menu blank">
                    <li><a class="link_name" href="#" onclick="toggleContent('chatContent')">Chat</a></li>
                </ul>
            </li>
            <li>
    ...
    <section class="home-section">
        <div class="home-content">
            <div class="topbar">
                <div class="topbar2">
                    ...
                    <div class="wrapper">
                        ...
                        <a href="#" class="" onclick="toggleContent('chatContent')">
                            <i class="bi bi-envelope fs-1"></i>
                            <span class="badge bg-danger rounded-pill">+1</span>
                        </a>
                        <p class="admjd">Bidan</p>
            ...
            <div class="submain">
                ...
                <div id="chatContent" class="content" style="display: none;">
                    <?php include 'form/chat.php'; ?>
                </div>
                <div id="bidanContent" class="content" style="display: none;">
                    <?php include 'form/balas.php'; ?>
                </div>
...
pickerPosition:bottom
    ...
    <!-- =========== Scripts =========  -->
    <script src="/assets/js/bidan.js"></script>
