                    ...
                    <h2>Data <b>Anak</b></h2>
                        <div class="row">
                            ...
                            <div class="col-sm-4 mt3">
                                ...
                                <button type="button" class="btn btn-primary text-white h-75" style="border-radius: 15px;" id="openPopupfilter">
...
<div class="popup" id="popupfilter">
    <div class="popup-content">
        <span class="close" id="closePopupfilter" style="float: right;">&times;</span>
        <!-- Isi form tambah data -->
        <?php include 'inputan/filter.php'; ?>
    </div>
</div>
