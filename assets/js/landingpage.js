...
(function() {
  ...
  document.addEventListener('DOMContentLoaded', function() {
  document.getElementById('openPopuplogin-1').addEventListener('click', function() {
    document.getElementById('popup').style.display = 'none';
    document.getElementById('popupregister').style.display = 'none';
    document.getElementById('popup-1').style.display = 'block';
  });
  
  document.getElementById('closePopuplogin-1').addEventListener('click', function() {
  ...
  document.addEventListener('DOMContentLoaded', function() {
    ...
    document.getElementById('closePopupregister').addEventListener('click', function() {
      document.getElementById('popupregister').style.display = 'none';
    });
    document.getElementById('closePopupregister-login').addEventListener('click', function() {
      document.getElementById('popupregister').style.display = 'none';
      document.getElementById('popup-1').style.display = 'block';
    });
