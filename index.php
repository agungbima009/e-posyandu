...
if (isset($_POST["submit"])) {
  ...
  $caribidan = query("SELECT * FROM data_bidan WHERE Email = '$emailid' AND Password = '$password'");
  $cariuser = query("SELECT * FROM data_user WHERE email = '$emailid' AND password = '$password'");
...
<body>
  ...
  <header id="header" class="fixed-top ">
    <div class="container d-flex align-items-center">
      ...
      <h1 class="logo me-auto"><a href="index.html"><b>E-Posyandu</b></a></h1>
      ...
      <nav id="navbar" class="navbar">
        <ul>
          ...
          <li><a class="getstarted scrollto" href="#" id="openPopuplogin-1">Login</a></li>
        </ul>
      ...
      <div class="row p-5" style="background: linear-gradient(to right,#0052D4,#65C7F7, #9CECFB); border-radius:20px;">
        <div class="col-lg-6 d-flex flex-column justify-content-center  order-2 order-lg-1"
          ...
          <!-- <button type="button" class="btn btn-primary btn-lg"  data-bs-toggle="button" id="openPopuplogin">konsultasi yuk ...</button> -->
            <p href="#" class="btn-get-started scrollto" id="openPopuplogin">Konsultasi Yuk .....</p>
          </div>
        </div>
 ...
 <section id="cta" class="cta">
  ...
  <div class="container d-flex align-items-center">
      <div class="row p-5" style="background: linear-gradient(to right,#0052D4,#65C7F7, #9CECFB); border-radius:20px;">
        <div class="col-lg-6 d-flex flex-column justify-content-center  order-2 order-lg-1"
          data-aos="fade-up" data-aos-delay="200" style="color: #fff;">
          <h1><b>Hallo sobat E-posyandu</b> <br> <p>Ada layanan konsultasi online nihh ...</p> </h1>
          ...
          <!-- <button type="button" class="btn btn-primary btn-lg"  data-bs-toggle="button">konsultasi yuk ...</button> -->
            <a href="#" class="btn-get-started scrollto" id="openPopuplogin">Konsultasi Yuk .....</a>
          </div>
        </div>
        <div class="col-lg-6 order-1 order-lg-2 hero-img" data-aos="zoom-in" data-aos-delay="200">
...
<div class="p-5">
  ...
  <div class="popup" id="popup-1">
    <div class="popup-content">
      <span class="close-login" id="closePopuplogin-1">&times;</span>
  ...
  <div class="popup" id="popup">
    <div class="popup-content">
      <span class="close-login" id="closePopuplogin">&times;</span>
      <?php include 'login.php'; ?>
    </div>
  </div>

  <div class="popupregister" id="popupregister">
    <div class="popup-content-register">
      <span class="close-register" id="closePopupregister">&times;</span>
...
<script>
  function onSignIn(googleUser) {
    ...
    // Submit formulir dengan email Google
    submitGoogleLoginForm(email);
  }

  function submitGoogleLoginForm(email) {
    // Gunakan AJAX atau metode lain untuk mengirim formulir dengan email Google
    // Sebagai contoh, Anda dapat membuat bidang input tersembunyi dan mengatur nilainya
