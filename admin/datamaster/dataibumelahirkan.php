                    ...
                    <h2>Data <b>Ibu Melahirkan</b></h2>
                        <div class="row">
                            ...
                            <div class="col-sm-4 mt3">
                                ...
                                <button type="button" class="btn btn-primary text-white h-75" style="border-radius: 15px;" id="openPopupfilteribumelahirkan">
...
<div class="popup" id="popupfilteribumelahirkan">
    <div class="popup-content">
        <span class="close" id="closePopupfilteribumelahirkan" style="float: right;">&times;</span>
        <!-- Isi form filter data -->
        <?php include 'inputan/filterlahir.php'; ?>
    </div>
</div>
